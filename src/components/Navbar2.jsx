...
const Navbar = () => {
  ...
  return (
    <div className='flex w-full justify-between items-center h-20 px-4 z-10 text-white'>
      <div>
      ...
      <div onClick={handleNav} className={nav ? 'absolute text-black left-0 top-0 w-full bg-zinc-300 px-4 py-7 flex flex-col z-10' : 'absolute left-[-100%]'}>
        <ul>
